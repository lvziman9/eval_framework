...
The registered SEP values and Batch 1 curve findings are retained unchanged. The dissertation does not independently validate the semantic direction of SEP against user perception or external serendipity judgments. SEP-oriented results describe movement along the implemented SEP objective.
