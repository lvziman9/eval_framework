...
| ------------ | ------- | ------- | --------------------------- | ------------- |
| Figure 3.1 Overview of the implemented canonical native-path evaluation framework | 3 | Show the framework flow from canonical data to report layer. | Generated conceptual figure: `paper/drafts_ch3_6/figures/figure_3_1_framework_overview.png`. | `thesis_analysis_pack/goal_12_chapter_3_material_pack.md`; `docs/guides/CANONICAL_DATASET_STANDARD.md`; `docs/guides/NATIVE_PATH_EXPERIMENT_ARCHITECTURE_2026-06-11.md`. |
| Figure 3.2 Alpha-sweep trade-off experiment design | 3 | Show how alpha changes ranking objective while strict accuracy remains separate. | Generated conceptual figure: `paper/drafts_ch3_6/figures/figure_3_2_alpha_sweep_design.png`. | `thesis_analysis_pack/final_explanation_summary_table.md`; canonical trade-off CSV bundles. |
