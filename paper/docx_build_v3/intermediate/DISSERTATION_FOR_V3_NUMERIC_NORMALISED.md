...
| PGPR/UCPR ablation | Frozen original top-k item set with exact alpha=0.00 preservation and a declared NDCG-retention analysis | `reports/tables/ablation/pgpr_ucpr_path_module/` | Separate from both the six-model sweep and strict final accuracy. |
...
| Dataset | Model | LIR alpha=0.00 -> alpha=1.00 | SEP alpha=0.00 -> alpha=1.00 | ETD alpha=0.00 -> alpha=1.00 |
| --- | --- | --- | --- | --- |
...
**Table 4.2.** LIR, SEP, and ETD endpoints at alpha=0.00 and alpha=1.00 for the validated LastFM and ML-1M native-path rows. These endpoints use the registered repository-specific metric implementation, belong to the alpha-sweep evidence stream, and are not strict accuracy measurements or user-study evidence.
...
| Dataset | Model | Role | Objective | Alpha=0.00 preservation | Selected alpha | NDCG retention (%) | Explanation gain (%) |
| --- | --- | --- | --- | --- | --- | --- | --- |
| LastFM | PGPR | main | LIR | PASS | 1.0 | 99.942 | 502.174 |
| LastFM | PGPR | main | SEP | PASS | 0.75 | 95.125 | 35.063 |
| LastFM | PGPR | main | ETD | PASS | 1.0 | 98.855 | 3.470 |
| LastFM | UCPR | auxiliary | LIR | PASS | 1.0 | 99.958 | 124.762 |
| LastFM | UCPR | auxiliary | SEP | PASS | 0.9 | 101.102 | 41.102 |
| LastFM | UCPR | auxiliary | ETD | PASS | 1.0 | 99.902 | 17.411 |
| ML-1M | PGPR | main | LIR | PASS | 0.55 | 99.075 | 56.306 |
| ML-1M | PGPR | main | SEP | PASS | 0.95 | 95.098 | 47.713 |
| ML-1M | PGPR | main | ETD | PASS | 1.0 | 99.376 | 15.270 |
| ML-1M | UCPR | auxiliary | LIR | PASS | 1.0 | 97.170 | 44.487 |
| ML-1M | UCPR | auxiliary | SEP | PASS | 0.75 | 96.927 | 33.386 |
| ML-1M | UCPR | auxiliary | ETD | PASS | 1.0 | 98.658 | 5.914 |
