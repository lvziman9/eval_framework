...
Produces:
    reports/figures/tradeoff/tradeoff_<dataset>_<exp_metric>.png  — Pareto frontier
    reports/figures/tradeoff/tradeoff_<dataset>_<exp_metric>.csv  — underlying data table
"""
